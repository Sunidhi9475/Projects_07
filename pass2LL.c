...
void main()
{
 ...
 fp1=fopen("C:\\Users\\sunid\\Desktop\\ss\\inputll2.txt","r");
 fp2=fopen("C:\\Users\\sunid\\Desktop\\ss\\ESTAB.txt","r");
 fp3=fopen("C:\\Users\\sunid\\Desktop\\ss\\outputll2newest.txt","w");
 while(!feof(fp2))
 {
...
fclose(fp3);
 ...
 printf("\nAddress\t\t\t\tContents");
 printf("\n---------------------------------------------------------------\n");
 fp3=fopen("C:\\Users\\sunid\\Desktop\\ss\\outputll2newest.txt","r");
 ch=fgetc(fp3);
 while(ch!=EOF)
 {
  printf("%c",ch);
